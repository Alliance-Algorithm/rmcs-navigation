...
local Points = {
    ...
    kOrigin = Map:point("kBegin", { x = 0.0, y = 0.0 }), -- 1
    kHome = Map:point("kHome", { x = -1.8, y = -5.0 }), -- 2

    kSelfHighlandBegin = Map:point("kSelfHighlandBegin", { x = 2.7, y = 1.7 }), -- 3
    kSelfHighlandFinal = Map:point("kSelfHighlandFinal", { x = 2.7, y = 4.0 }), -- 4

    kAttackRune = Map:point("kAttackRune", { x = 6.6, y = 3.7 }), -- 5
    kAttackOutpost = Map:point("kAttackOutpost", { x = 7.9, y = 5.3 }), -- 6

    kBehindOutpost = Map:point("kBehindOutpost", { x = 6.2, y = -3.9 }), -- 7
    kSelfStepBegin = Map:point("kSelfStepBegin", { x = 4.5, y = -4.3 }), -- 8
    kSelfStepFinal = Map:point("kSelfStepFinal", { x = 4.5, y = -6.3 }), -- 9

    kSelfSlopeBegin = Map:point("kSelfSlopeBegin", { x = 8.2, y = -6.8 }), -- 10
    kThemSlopeFinal = Map:point("kThemSlopeFinal", { x = 8.3, y = 7 }), -- 11

    kSelfDoubleStepsBegin = Map:point("kSelfDoubleStepsBegin", { x = 4.7, y = 0 }), -- 12
    kSelfDoubleStepsFinal = Map:point("kSelfDoubleStepsFinal", { x = 7.5, y = 0 }), -- 13

    kSelfFortressRight = Map:point("kSelfFortressRight", { x = 2.5, y = -2.0 }), -- 22

    -- 中央高地

    kNearSelfOutpost = Map:point("kNearSelfOutpost", { x = 10.4, y = -4 }), -- 14
    kNearThemOutpost = Map:point("kNearThemOutpost", { x = 10.4, y = 4 }), -- 15

    -- 对方半场

    kThemDoubleStepsBegin = Map:point("kThemDoubleStepsBegin", { x = 16.0, y = 0 }), -- 20
    kThemDoubleStepsFinal = Map:point("kThemDoubleStepsFinal", { x = 13.3, y = 0 }), -- 21

    kThemStepBegin = Map:point("kThemStepBegin", { x = 16.2, y = 4.3 }), -- 16
    kThemStepFinal = Map:point("kThemStepFinal", { x = 16.2, y = 6.3 }), -- 17

    kThemHighlandBegin = Map:point("kThemHighlandBegin", { x = 17.5, y = -1.6 }), -- 18
    kThemHighlandFinal = Map:point("kThemHighlandFinal", { x = 17.5, y = -3.7 }), -- 19
    
    kThemFortressRight = Map:point("kThemFortressRight", { x = 18.5, y = 2.0 }), -- 23
    
    kThemHomeDoor = Map:point("kThemHomeDoor", { x = 21.5, y = 2.0 }), -- 24
}
...
Map:connect(Points.kThemStepBegin, Points.kThemFortressRight) { rough_navigate, rough_navigate }
Map:connect(Points.kThemDoubleStepsBegin, Points.kThemFortressRight) { rough_navigate, rough_navigate }

Map:connect(Points.kThemFortressRight, Points.kThemHomeDoor) { rough_navigate, rough_navigate }
