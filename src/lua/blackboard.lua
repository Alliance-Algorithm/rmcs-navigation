...
local function create_default_blackboard()
	...
	local result = {
		...
		rule = {
			...
			road_zone_way_point_1 = PointPair { { 0, 0 }, { 0, 0 } },
			road_zone_way_point_2 = PointPair { { 0, 0 }, { 0, 0 } },
			road_zone_way_point_3 = PointPair { { 0, 0 }, { 0, 0 } },
			launch_ramp_begin = PointPair { { 0, 0 }, { 0, 0 } }, -- 飞坡
			launch_ramp_final = PointPair { { 0, 0 }, { 0, 0 } },
			outpost_resupply = PointPair { { 0, 0 }, { 0, 0 } }, -- 前哨站补给点
			attack_outpost_point = PointPair { { 0, 0 }, { 0, 0 } },
			assembly_zone = PointPair { { 0, 0 }, { 0, 0 } },
			central_highland_near_fluctuant_road = PointPair { { 0, 0 }, { 0, 0 } },
			central_highland_near_doghole = PointPair { { 0, 0 }, { 0, 0 } },
			central_highland_middle = PointPair { { 0, 0 }, { 0, 0 } },
			central_highland_gain_point = PointPair { { 0, 0 }, { 0, 0 } },
			central_highland_near_two_steps_and_outpost = PointPair { { 0, 0 }, { 0, 0 } },
			base_left_gain_point = PointPair { { 0, 0 }, { 0, 0 } },
			base_right_gain_point = PointPair { { 0, 0 }, { 0, 0 } },
			...
			fluctuant_road_begin = PointPair { { 0, 0 }, { 0, 0 } },
